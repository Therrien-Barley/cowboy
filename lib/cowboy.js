...
cowboy.prototype.mask = function(depth_imagepath, rgb_imagepath, destination_path, imagename, threshold){
	...
	var gmargs = depth_imagepath + " -colorspace Gray -write mpr:mask +delete mpr:mask -fill white -opaque black -write mpr:mask +delete mpr:mask -threshold " + threshold + " -write mpr:mask +delete mpr:mask -negate -write mpr:mask +delete " + rgb_imagepath + " mpr:mask -alpha Off -compose CopyOpacity -composite " + destination_path + imagename;
